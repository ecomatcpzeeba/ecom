  ...
  return (
    <div className="flex justify-center">
      <div className="w-2/3">
        ...
        CHENNAI PLAZA believes in helping its customers as far as possible, and
        ...
        <ul className="list-disc">
          <li>
            ...
            15 days of placing the order. However, the cancellation request may
          ...
          <li>
            ...
            his own end. This should be reported within 15 days of receipt of
            the products.
          </li>
          <li>
            ...
            our customer service within 15 days of receiving the product. The
          ...
          <li>
            In case of any Refunds approved by the CHENNAI PLAZA, it&apos;ll
