    ...
    <div className="flex justify-center">
      <div className="w-2/3">
        ...
        <p className="">
          ...
          within 15-21 days or as per the delivery date agreed at the time of
          order confirmation and delivering of the shipment subject to Courier
          Company / post office norms. CHENNAI PLAZA is not liable for any delay
          ...
          postal authorities within 15-21 days rom the date of the order and
          ...
          services you may contact our helpdesk on 7358285640 or
          ecom.chennaiplaza@gmail.com
        </p>
      </div>
    </div>
  )
